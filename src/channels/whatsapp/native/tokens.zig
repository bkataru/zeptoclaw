...
// Generated from whatsmeow binary/token/token.go DictVersion 3
...
pub const double_byte_tokens = [4][256][]const u8{
    [_][]const u8{
        "read-self",
        "active",
        "fbns",
...
pub fn singleIndexOf(s: []const u8) ?u8 {
    for (single_byte_tokens, 0..) |tok, i| if (std.mem.eql(u8, tok, s)) return @intCast(i);
    return null;
}

pub fn doubleIndexOf(s: []const u8) ?struct{d: u8, i: u8} {
