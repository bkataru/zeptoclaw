...
echo "   curl https://zeptoclay-router.<your-subdomain>.workers.dev/health"
echo ""
echo "2. Test chat completions:"
echo "   curl -X POST https://zeptoclay-router.<your-subdomain>.workers.dev/v1/chat/completions \\"
